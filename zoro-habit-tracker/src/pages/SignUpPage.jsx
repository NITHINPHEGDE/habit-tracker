...
export default function SignUpPage({setView,onAuth}){
  ...
  return(
    <motion.div initial={{opacity:0,x:30}} animate={{opacity:1,x:0}} exit={{opacity:0,x:-30}} transition={{duration:0.35,ease:[0.22,1,0.36,1]}}
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"center",padding:"32px 24px 40px"}}>
        <div style={{marginBottom:32,textAlign:"center"}}>
          ...
          <h1 style={{fontFamily:F.display,fontSize:28,color:C.ivory}}>Begin Training</h1>
        </div>
        <div style={{height:1,background:`linear-gradient(90deg,transparent,${C.border},transparent)`,marginBottom:28}}/>
        ...
        <div style={{marginTop:24}}><PrimaryButton onClick={handleSubmit} loading={loading}>⚔ Forge My Account</PrimaryButton></div>
        <p style={{textAlign:"center",marginTop:20,fontSize:15,color:C.ivoryFaint}}>Already have an account?{" "}
